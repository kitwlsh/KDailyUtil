...
- **지문**: 🔴 **일요일에는 장문**(800~1,200자 ≈ 40~60초) · 앱은 **글자 수로** 판정해 「📜 긴 지문」 표시
...
| 퀴즈·지문 로봇 | ✅ 09-13 실행 `ok` — 퀴즈 **550문항** · 지문 **8편** · `quotaWaits: 0`. 🔴 **일요일은 장문**(09-14부터) |
