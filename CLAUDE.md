...
🕐 **v1.7.1(vc9)을 2026-09-08에 업로드했다 — 현재 «검토 중».**
...
| 저장소 | 스토어와 같다 — **v1.7.1(vc9)까지 올리고 나면 밀린 분량이 0건이다**(검토 중) |
| 소스 버전 | `versionCode = 9` / `versionName = "1.7.1"` — 09-08 업로드 완료·검토 중. 다음 업로드는 **vc10** |
