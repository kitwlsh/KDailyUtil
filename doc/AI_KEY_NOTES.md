...
| 시각(UTC) | 실행 | 퀴즈 | 지문 |
|---|---|---|---|
| 09-07 02:46 | 예약 | ✅ 성공 | ✅ 성공(1편) |
| 09-08 01:08 / 01:11 / 01:34 | **수동 3회** | ❌ 429 | ❌ 429 |
| 09-08 **02:09:33 / :34** | 예약 | ❌ **429**(retry in 26.2s) | ✅ **성공**(2편째) |

🔴 **마지막 줄이 결정적이다.** **같은 키·같은 별칭(`gemini-flash-latest`)으로 1초 차이**인데
