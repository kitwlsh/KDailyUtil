...
|---|---|---|---|---|---|
| KDailyUtil | `com.kitwlshcom.kdailyutil` | `ic_k_app_icon.png` | 데일리 라이프 유틸(뉴스/증시/오디오/퀴즈/배움터) | `com.kitwlshcom.kdailyutil` | **라이브 v1.7.2(vc10, 2026-09-17 출시)** — 이전 v1.7.1(vc9, 09-09) · v1.7.0(vc8, 09-08) · §8 동적 레지스트리 적용본은 v1.6(vc6, 08-04)부터 |
...
>
> ⚠️ 단, 이 전환은 **각 앱이 한 번 배포돼야 효력이 생긴다**(**KDailyUtil vc6/v1.6 — ✅ 2026-08-04 배포 완료**, **KLotto645 vc12/v1.0.2 — ✅ 2026-08-03 배포 완료**, K장부는 첫 출시본부터). 그 이후로는 **신규 자매앱 추가에 어떤 앱도 재배포하지 않는다**(§8-9).
...
| 앱 | 전환 상태 | 다음 배포 |
|---|---|---|
| **KDailyUtil** | ✅ **구현 + 🚀 배포 완료(2026-08-04)** — Compose + Coil. **실기기 검증 10/10 통과(§8-12)** | **vc6 / v1.6으로 적용** · 현재 라이브 **vc10 / v1.7.2** |
...
> ⚠️ **전환은 배포돼야 효력이 생긴다.** ✅ **세 앱 모두 적용본이 라이브다**(2026-09-09 현재) — KLotto645 v1.0.2(08-03) · **KDailyUtil v1.6(08-04)** · K장부는 첫 출시본부터. 업데이트를 받은 사용자부터 동적 카드가 보이고, 그 뒤로는 영구히 JSON만으로 관리된다.
