...
>
> **현재 상태(2026-08-07)**: 3개 앱 전부 라이브(KDailyUtil v1.6 · KLotto645 v1.0.3 · **K장부 v1.0.0**).
> K장부 출시로 `comingSoon: true→false` 전환을 정본·번들에 반영했다. ⏳ **`k-series-config` 레포 반영은 수동으로 해야 한다.**
