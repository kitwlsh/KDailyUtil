...
> ### 🚩 지금 상태 (신규 세션 필독)
> - 🕐 **v1.7.0 (versionCode 8) — 2026-09-07 업로드 완료·검토 중.** 🔴 vc8 소모됨 → 다음 업로드는 **vc9**.
...
- **최소 SDK**: 26 / 타겟 SDK: 36
- **버전**: 소스 = versionCode **8** / versionName **1.7.0** = **2026-09-07 업로드·검토 중**. 게시본은 vc7/1.6.1(08-12 출시). 스킴 = 유의적 버전(아래 § 참고, `versionCode`와 분리). 🔴 1.6.2가 아닌 이유 = 지문 공급이 **기능 추가**여서 MINOR가 올라갔다.
