...
> 🕐 **다음 = v1.6.1(vc7) — 2026-08-11 Play Console 업로드 완료·검토 중.** 통과하면 게시본이 v1.6.1이 된다.
...
## 📌 Google Play '출시 노트' 붙여넣기용 문구 — v1.6.1 (🕐 업로드 완료·검토 중)
...
>
> **업로드 완료(2026-08-11) — 검토 중.** 통과 전까지 라이브는 v1.6이라 신규 설치자의 AI 장애는 아직 진행 중이다.
>
