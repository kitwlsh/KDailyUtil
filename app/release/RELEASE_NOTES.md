...
> 🕐 **업로드 완료·검토 중: `kdailyutil-v1.7.0.aab`** (versionCode 8 / versionName 1.7.0) — 2026-09-07 업로드. 🔴 다음 업로드는 **vc9**.
> 최신 게시본: **`kdailyutil-v1.6.1.aab`** (versionCode 7 / versionName 1.6.1) — 🎉 **2026-08-12 출시·라이브**.
> 스토어 게시 이력: **v1.6.1(vc7) 2026-08-12** · v1.6(vc6) 2026-08-04 · v1.5(vc5) 2026-07-23 · v1.4(vc4) 2026-07-21 · v1.2(vc3) 2026-07-08 · v1.1(vc2).
> ⏱ **심사 소요**: 08-11 업로드 → **08-12 라이브**(약 하루). 데이터 보안 양식을 함께 수정했어도 지연은 없었다.
...
## 🆕 v1.7.0 (versionCode 8) — 2026-09-07 업로드 완료 · 🕐 검토 중
...
> 둘째 날 안 오면 그 상태로 사용자에게 나간 것이니 **즉시 vc9로 고쳐 올린다**.
> 절차 = [NEXT_SESSION.md §업로드 직후·부록 A](../../doc/NEXT_SESSION.md).
