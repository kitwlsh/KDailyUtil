...
> 🕐 **업로드 완료·검토 중: `kdailyutil-v1.7.1.aab`** (versionCode 9 / versionName 1.7.1) — 2026-09-08 업로드. 🔴 다음 업로드는 **vc10**.
> 최신 게시본: **`kdailyutil-v1.7.0.aab`** (versionCode 8 / versionName 1.7.0) — 🎉 **2026-09-08 출시·라이브**.
...
## 🆕 v1.7.1 (versionCode 9) — 2026-09-08 업로드 완료 · 🕐 검토 중
