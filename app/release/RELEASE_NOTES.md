...
> 🆕 **업로드 대기: `kdailyutil-v1.7.0.aab`** (versionCode 8 / versionName 1.7.0) — 2026-09-07 빌드·서명 확인 완료.
...
## 🆕 v1.7.0 (versionCode 8) — 2026-09-07 빌드 완료 · ⏳ 업로드 대기
...
>
> 🔴 **업로드 전에 남은 것**: 실기기 확인(절차 = [NEXT_SESSION.md 부록 A](../../doc/NEXT_SESSION.md)).
> 특히 **알람이 이틀 연속 오는지**(이번에 고친 버그라 하루만 보면 못 잡는다)와 **오늘의 지문이 뜨는지**.
