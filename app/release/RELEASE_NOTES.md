...
> 스토어 게시 이력: **v1.7.0(vc8) 2026-09-08** · v1.6.1(vc7) 2026-08-12 · v1.6(vc6) 2026-08-04 · v1.5(vc5) 2026-07-23 · v1.4(vc4) 2026-07-21 · v1.2(vc3) 2026-07-08 · v1.1(vc2).
> ⏱ **심사 소요**: 두 번 연속 **약 하루**다 — 08-11→08-12(v1.6.1), 09-07→09-08(v1.7.0). 데이터 보안 양식을 함께 수정해도 지연은 없었다.
