...
> 📦 **업로드 대기: `kdailyutil-v1.7.1.aab`** (versionCode 9 / versionName 1.7.1) — 2026-09-08 빌드·서명 확인 완료. 🔴 다음 업로드는 **vc10**.
...
## 🆕 v1.7.1 (versionCode 9) — 2026-09-08 빌드 완료 · 📦 업로드 대기
...
>
> 🔴 **`versionCode 9`는 이 빌드가 가져갔다.** 반려되어 다시 올리는 경우에도 다음은 **vc10**이다.
