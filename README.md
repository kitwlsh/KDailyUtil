...
3. **리텐션 한 판** — 하루만 울리고 죽던 모닝 브리핑 알람 수정 + 오늘의 퀴즈·출석·오답 노트·배지(2026-09-04)
4. **503(AI 서버 과부하) 대응** — 13종 AI가 무방비였던 것 수정(2026-08-25)

> 🔴 **버전명이 `1.6.2`가 아니라 `1.7.0`인 이유**: 문서에 오래 적혀 있던 1.6.2는 vc8이 «버그 수정 + 리텐션»뿐일 때의 값이다.
> 지문 공급이 **기능 추가**라 버전 스킴 규칙(`기능추가 → MINOR`)에 따라 MINOR가 올라갔다.
...
> 최신은 위쪽에 있다. 게시본은 **v1.6.1(vc7, 2026-08-12 라이브)** 이고, 아래 2026-08-25·09-04·09-07 작업은 **아직 스토어에 없다**(**v1.7.0(vc8)** 빌드 완료·업로드 대기).

### 📖 매일 새 지문이 도착한다 — 독서 훈련 지문 공급 (2026-09-07 · ⏳ v1.7.0 업로드 대기)
...
### 🔴 「새 문제 N개」에 상한과 복귀 사면 (2026-09-07 · ⏳ v1.7.0 업로드 대기)
...
### 🔁 매일 한 번은 들어오게 — 리텐션 한 판 (2026-09-04 · ⏳ v1.7.0 업로드 대기)
...
### 🔥 503(AI 서버 과부하) 대응 (2026-08-25 · ⏳ v1.7.0 업로드 대기)
