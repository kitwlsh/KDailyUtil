...
| 📦 **빌드 완료 · 업로드 대기** | **v1.7.1 (versionCode 9)** — 2026-09-08 빌드. [`app/release/kdailyutil-v1.7.1.aab`](app/release/kdailyutil-v1.7.1.aab) (11,348,510 bytes) · 서명 SHA-256 `61:12:DE:…:A5:12:99` 확인 완료 · ✅ 실기기 확인 완료. 🔴 **다음 업로드는 vc10** |
| 빌드 상태 | 단위 테스트 **82건 통과** · `:app:bundleRelease`·`:app:compileReleaseKotlin` 성공 |
| 남은 일 | 🔴 **v1.7.1 업로드** · 그 뒤 vc8 몫이던 확인이 아직 남았다(**알람 이틀 연속** · `aiModel` 레버 · 데이터 보안 칸 · 깨끗한 계정 신규 설치) — [doc/NEXT_SESSION.md](doc/NEXT_SESSION.md) |
...
> 최신은 위쪽에 있다. 게시본은 **v1.7.0(vc8, 2026-09-08 라이브)** 이고, **2026-09-08의 독서 훈련 동선 작업만 아직 스토어에 없다**(**v1.7.1(vc9)** 빌드 완료·업로드 대기).

### 📌 독서 훈련 「시작까지 가는 길」을 줄였다 (2026-09-08 · 📦 v1.7.1 업로드 대기)
